...
test:
	docker-compose -p $(DEV_PROJECT_NAME) -f $(DEV_COMPOSE_FILE) build
	docker-compose -p $(DEV_PROJECT_NAME) -f $(DEV_COMPOSE_FILE) up agent
...
clean:
	...
	docker-compose -p $(DEV_PROJECT_NAME) -f $(DEV_COMPOSE_FILE) rm -f
	docker-compose -p $(REL_PROJECT_NAME) -f $(REL_COMPOSE_FILE) kill
	docker-compose -p $(REL_PROJECT_NAME) -f $(REL_COMPOSE_FILE) rm -f
